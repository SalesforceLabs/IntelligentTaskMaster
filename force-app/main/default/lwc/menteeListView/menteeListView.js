...
export default class menteeListView extends  NavigationMixin(LightningElement) {
    @track isExpanded = false;
    @track allItems = [];
    @track itemsForCurrentView;
    @track isLoaded = false;
    @track columns = [];
    @track title='My Mentees';
    noDataUrl = notFoundImage;
    @wire(getPersonProgress, {context:'MyMentees', mentorshipId:''})
